...
func getNameFromNamespace(namespace string) string {
	...
	namespace = strings.ReplaceAll(namespace, "ShipToDetails.Address", "ShipToDetails")
	namespace = strings.ReplaceAll(namespace, "DispatchDetails.Address", "DispatchDetails")
	namespace = strings.ReplaceAll(namespace, "DocumentDetails.Type", "DocumentType")
	namespace = strings.ReplaceAll(namespace, "DocumentDetails.DocumentNo", "DocumentNo")
	namespace = strings.ReplaceAll(namespace, "DocumentDetails.Date", "DocumentDate")
